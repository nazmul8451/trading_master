...
class _JournalScreenState extends State<JournalScreen> {
  ...
  Future<void> _loadData() async {
    ...
    if (mounted) {
      setState(() {
        ...
        _personalJournals = _storageService
            .getAllJournals()
            .where((j) => j.type == 'custom' && j.folderId == null)
            .toList();
        _isLoading = false;
      });
    }
        ...
        child: Column(
          ...
          children: [
            ...
            _buildOptionTile(
              ...
              title: 'New Note',
              subtitle:
                  'Jot down your latest trading ideas or personal thoughts',
  ...
  void _navigateToEditor({JournalModel? note}) async {
    final result = await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            NoteEditorScreen(existingNote: note, folderId: _selectedFolder?.id),
      ),
    );
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              Expanded(child: _isLoading ? _buildLoadingState() : _buildBody()),
            ],
          ),
        ),
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: Text(
            'New',
            style: AppTypography.buttonText.copyWith(fontSize: 14.sp),
          ),
        ),
      ),
    );
  ...
  Widget _buildTabSwitcher() {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: _buildTabItem(0, 'Personal', Icons.auto_stories_rounded),
          ),
  ...
  Widget _buildBody() {
    if (_selectedFolder != null) {
      final folderNotes = _storageService.getJournalsByFolder(
        _selectedFolder!.id,
      );
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            if (_personalJournals.isNotEmpty)
              Text(
                '${_personalJournals.length} Notes',
                style: AppTypography.bodySmall.copyWith(
                  color: AppColors.success,
        ...
        SizedBox(height: 16.h),
        if (_personalJournals.isEmpty)
          _buildEmptyState(
            'Your quick notes will appear here',
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  mainAxisAlignment:
                      MainAxisAlignment.end, // Push text to bottom
                  children: [
                    Text(
                      folder.name,
                      style: AppTypography.buttonText.copyWith(
